    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
            <div className="w-16 h-16 rounded-full bg-brand-orange flex items-center justify-center mx-auto mb-4 animate-pulse">
    ...
    <div>
      ...
      {cards.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 hover:border-brand-orange/40 transition-all">
        ...
        <div className="rounded-2xl border-2 border-dashed border-white/15 bg-white/5 p-12 text-center mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-brand-orange px-6 py-3 text-sm font-medium text-white hover:bg-[#e64a19] transition-all shadow-lg shadow-brand-orange/25"
          >
      ...
      {cards.length > 0 && (
        <>
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              href="/dashboard/cards/new"
              className="inline-flex items-center gap-2 rounded-lg bg-brand-orange px-4 py-2 text-sm font-medium text-white hover:bg-[#e64a19] transition-all shadow-lg shadow-brand-orange/25"
            >
              <Plus className="w-4 h-4" />
              New Card
            </Link>
